...
public class CircuitBreakerConfiguration
{
    ...
    public CircuitBreaker countCircuitBreaker()
    {
        ...
        CircuitBreaker cb = (CircuitBreaker) circuitBreakerRegistry.circuitBreaker("BooksSearchServiceBasedOnCount");
    ...
    public CircuitBreaker timeCircuitBreaker()
    {
        ...
        CircuitBreaker cb = (CircuitBreaker) circuitBreakerRegistry.circuitBreaker("BookSearchServiceBasedOnTime");
        return cb;
    }
}
